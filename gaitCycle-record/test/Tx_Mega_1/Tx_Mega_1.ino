...
#define calibration_factor_1 -23000.0 //found out exp increase or decrease for matching using std weights
#define DOUT1 3
#define CLK1 2
#define grav 9.80665
...
{ 
  ...
  Data.pitch = int(pitch*100)-pitch_init;
  Data.roll = int(roll*100)-roll_init;
  Data.gyrx = GYRX;
  Data.gyry = GYRY;
  Data.gyrz = GYRZ;
...
void _print()
{
  ...
  Serial.print("  roll =");Serial.print(roll-roll_init);
